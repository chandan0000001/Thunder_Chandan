//create a server which is listen at port no 3000
...
const server = http.createServer((request,Response)=>{
    // Response.end("Hello Chandan Fuck you");
    console.log(request.url); //last value returned "http://localhost:3000/20"  here /20
...
});  //value of server store in the server 
server.listen(3000 , ()=>{
    console.log("I am listening at port 3000 fuck you");
})